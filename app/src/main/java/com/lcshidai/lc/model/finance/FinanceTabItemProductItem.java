...
public class FinanceTabItemProductItem implements Serializable {
	...
	private String safeguards;// 担保类型 1-保 2-本
	private String safeguards_view;// 担保类型中文显示
	private String time_limit; // 期限
	private String time_limit_unit;// 期限单位
...
//	private String is_available = "";// -> 是否提醒（1: 是, 0: 否）
	...
	private String remaining_amount_view;// 剩余磕头金额
...
//	private String big_icon;//追加icon 图片地址
	...
	private String remaining_prefix;
	private String remaining_middle;
	private String remaining_suffix;

//	added by randy zhang at 2017/04/20
	private int is_collection;
//  added by randy zhang at 2017/06/06
	...
	@JsonProperty("safeguards")
	public void setSafeguards(String safeguards) {
		this.safeguards = safeguards;
	}
	public String getSafeguards_view() {
		return safeguards_view;
	}
	@JsonProperty("safeguards_view")
	public void setSafeguards_view(String safeguards_view) {
		this.safeguards_view = safeguards_view;
	}
	...
	public String getRemaining_amount_view() {
		return remaining_amount_view;
	}
	@JsonProperty("remaining_amount_view")
	public void setRemaining_amount_view(String remaining_amount_view) {
		this.remaining_amount_view = remaining_amount_view;
	}
	...
	public String getRemaining_prefix() {
		return remaining_prefix;
	}

	@JsonProperty("remaining_prefix")
	public void setRemaining_prefix(String remaining_prefix) {
		this.remaining_prefix = remaining_prefix;
	}

	public String getRemaining_middle() {
		return remaining_middle;
	}

	@JsonProperty("remaining_middle")
	public void setRemaining_middle(String remaining_middle) {
		this.remaining_middle = remaining_middle;
	}

	public String getRemaining_suffix() {
		return remaining_suffix;
	}

	@JsonProperty("remaining_suffix")
	public void setRemaining_suffix(String remaining_suffix) {
		this.remaining_suffix = remaining_suffix;
	}
