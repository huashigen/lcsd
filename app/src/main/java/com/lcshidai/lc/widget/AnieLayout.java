...
public class AnieLayout extends LinearLayout{
	 ...
	 public AnieLayout(Context context) {
	        super(context);
	    }

	    public AnieLayout(Context context, AttributeSet attrs) {
	        super(context, attrs);
	    }

	    public AnieLayout(Context context, AttributeSet attrs, int defStyle) {
	    ...
	    public void setYFractionH(float fraction) {
	        this.yFraction = fraction;
	        if (getHeight() == 0) {
	            if (preDrawListener == null) {
	                preDrawListener = new ViewTreeObserver.OnPreDrawListener() {
	    ...
	    public void setZoomFromCornerPivotHeightY(float fraction) {
	        //setScaleY(fraction);
	        setPivotX(0);
	        setPivotY(getHeight());
	    }
