...
//			//slide to left
//			if (context instanceof AbsSubActivity||context instanceof GestureLoginActivity||context instanceof InvestSuccessActivity) {
////				((ImageViewer4GifActivity)context).onBackPressed();
//			} else {
//				((Activity)context).finish();
//				((Activity)context).overridePendingTransition(R.anim.hold,R.anim.activity_right_out);
//			}
//			return true;
//		} else 
		if (
			...
			//slide to right FundListInfoActivity ManageFinanceListInfoActivity
//			if (context instanceof AbsSubActivity||context instanceof GestureLoginActivity||context instanceof InvestSuccessActivity||context instanceof FundListInfoActivity||context instanceof ManageFinanceListInfoActivity||context instanceof ManageFinanceInfoActivity) {
////				((ImageViewer4GifActivity)context).onBackPressed();
//			} else {
//			}
			((TRJActivity)context).doFinish();
			((TRJActivity)context).overridePendingTransition(R.anim.hold,R.anim.activity_right_out);
			return true;
		}
