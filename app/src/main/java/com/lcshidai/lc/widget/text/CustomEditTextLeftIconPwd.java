...
public class CustomEditTextLeftIconPwd extends LinearLayout{
	...
	public CustomEditTextLeftIconPwd(Context context) {
		super(context);
	}
	
	public CustomEditTextLeftIconPwd(Context context,AttributeSet attrs) {
		super(context,attrs);
		View view = LayoutInflater.from(context).inflate(R.layout.custom_edit_lefttextpwd,this, true);
