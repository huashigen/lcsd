...
public class PagerSlidingTabStripManageFinance extends HorizontalScrollView {
	...
	private int indicatorColor = 0xff63AF6F;
	private int underlineColor = 0xffCECECE;
	private int dividerColor = 0xFF811C;
	...
	private int tabPaddingr = 19;
	private int dividerWidth = 1;
	private int tabTextSize = 16;
	private int tabTextColor = 0xff000000;

	private int tabTextSizer = 16;
	private int tabTextColorr = 0xff63AF6F;
	...
	public PagerSlidingTabStripManageFinance(Context context) {
		this(context, null);
	}

	public PagerSlidingTabStripManageFinance(Context context, AttributeSet attrs) {
	...
	public PagerSlidingTabStripManageFinance(Context context, AttributeSet attrs,
		...
		indicatorColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsIndicatorLineColor, indicatorColor);
		underlineColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsUnderlineColor, underlineColor);
		dividerColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsDividerLineColor, dividerColor);
		indicatorHeight = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsIndicatorHeight, indicatorHeight);
		underlineHeight = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsUnderlineHeight, underlineHeight);
		dividerPadding = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsDividerPadding, dividerPadding);
		tabPadding = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsTabPaddingHorizontal, tabPadding);
		tabBackgroundResId = a.getResourceId(R.styleable.PagerSlidingTabStrip_pstsDefaultTabBackground, tabBackgroundResId);
...
//		defaultTabLayoutParams = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT);
	...
	public void notifyDataSetChanged() {
		...
		tTRJount = pager.getAdapter().getCount();

		for (int i = 0; i < tTRJount; i++) {
	...
	protected void onDraw(Canvas canvas) {
		...
		if (currentPositionOffset > 0f && currentPosition < tTRJount - 1) {
