...
public class ViewFlow extends AdapterView<Adapter> {
    ...
    public boolean enjoinLeft = false;
...
//		if((mCurrentAdapterIndex + 1) == mAdapter.getCount()){
//			return false;
//		}
        if (getChildCount() == 0)
            return false;
...
//		}
    ...
    private void logBuffer() {
        Log.d(getClass().getSimpleName(), "Size of mLoadedViews: " + mLoadedViews.size() +
                ", Size of mRecycledViews: " + mRecycledViews.size() +
                ", X: " + mScroller.getCurrX() + ", Y: " + mScroller.getCurrY());
        Log.d(getClass().getSimpleName(), "IndexInAdapter: " + mCurrentAdapterIndex
