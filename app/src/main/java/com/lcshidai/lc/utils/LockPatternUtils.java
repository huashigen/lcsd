...
public class LockPatternUtils {
    ...
    private static LockPatternUtils lockPatternUtil;
    private static final String TAG = "LockPatternUtils";
    private static final String LOCK_PATTERN_FILE = "gesture_lock.key";
    /**
    ...
    public static LockPatternUtils getInstance(Context context) {
        ...
        if (lockPatternUtil == null) {
            synchronized (LockPatternUtils.class) {
                if (lockPatternUtil == null) {
                    lockPatternUtil = new LockPatternUtils(context);
                }
            }
        }

        return lockPatternUtil;
    }
